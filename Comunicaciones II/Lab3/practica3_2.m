...
NSIMB_array = [4385, 5882, 7936, 11235, 16666, 25641, 41666, 71428];
EbNo_dB_array_len = size(EbNo_dB_array,2);
Pe_teo = [0.0228, 0.017, 0.0126, 0.0089, 0.006, 0.0039, 0.0024, 0.0014];
...
ylabel('Pe')
xlabel('Eb/No')
title('Probabilidad de error para distintos valores de Eb/No (Antípoda)');
