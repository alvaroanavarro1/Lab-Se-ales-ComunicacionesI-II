...
EbNo_dB_array = 2:1:9;
BER_Teo = [0.2112, 0.1586, 0.1142, 0.0768, 0.0466, 0.0258, 0.0120, 0.005];
Nsim_array = [500, 714, 1000, 1250, 2272, 3333, 8333, 20000];
...
legend('Pes Experimental','Pes Teórico')
ylabel('Pes')
xlabel('Eb/No')
...
%title('BER vs EbNo (2dB, 5dB, 10dB, 100dB)');